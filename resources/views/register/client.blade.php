          ...
          <div class="form-daftar w-full self-center px-4 lg:w-1/2">
            ...
            <ul class="flex mt-8 justify-between">
              <li class="text-start px-4 md:px-0">
                <a href="regind" class="flex text-base font-semibold text-dark mx-8 mt-1 py-1 px-8 rounded-full hover:bg-pink hover:text-white transition duration-300 ease-in-out">Individu</a>
              </li>
