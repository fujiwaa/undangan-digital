...
<html lang="en">
  ...
  <body>
    ...
    <!-- Form Login -->
    <section id="login" class="bg-cover bg-center" style="background-image: url('img/bg-login.png')">
      <div class="container">
        <div class="flex flex-wrap">
          <div class="w-full px-4 lg:w-1/2">
            <div class="relative lg:mt-10 lg:right-0">
              <img src="img/login.png" alt="WeMarried" class="login" />
            </div>
          </div>

          <div class="form-login w-full self-center px-4 lg:w-1/2">
            <h2 class="font-bold text-center md:text-3xl">Login Sebagai</h2>
            <ul class="flex mt-8 justify-between">
              <li class="text-start px-4 md:px-0">
                <a href="logind" class="flex text-base font-semibold text-dark mx-8 mt-1 py-1 px-8 rounded-full hover:bg-pink hover:text-white transition duration-300 ease-in-out">Individu</a>
              </li>
              <li class="text-center px-4 md:px-0">
                <a href="" class="flex text-base font-semibold text-white mx-8 mt-1 py-1 px-8 rounded-full border border-pink bg-pink transition duration-300 ease-in-out">Vendor</a>
              </li>
            </ul>
            <h3 class="text-base mt-8 mx-8"><span class="text-pink">Vendor</span>, buat kamu yang ingin bekerja sama dengan WeMarried</h3>
            <form action="" method="POST">
              @csrf
                ...
                <button type="submit" class="text-white bg-pink font-medium rounded-lg text-sm sm:w-auto px-8 py-2.5 mx-8">Masuk</button>
            </form>
            <h3 class="text-normal text-center mt-8">Belum punya akun? <a href="/register" class="text-pink">Daftar disini</a></h3>
          </div>
        </div>
      </div>
    </section>
