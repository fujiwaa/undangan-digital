        ...
        <div class="flex flex-wrap">
          ...
          <div class="form-login w-full self-center px-4 lg:w-1/2">
            ...
            @if(Session::has('success'))
                <div class="p-4 mt-4 mx-8 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
                    {{ Session::get('success') }}
                </div>
            @endif
            ...
            <ul class="flex mt-8 justify-between">
              ...
              <li class="text-center px-4 md:px-0">
                <a href="logven" class="flex text-base font-semibold text-dark mx-8 mt-1 py-1 px-8 rounded-full hover:bg-pink hover:text-white transition duration-300 ease-in-out">Vendor</a>
              </li>
            </ul>
